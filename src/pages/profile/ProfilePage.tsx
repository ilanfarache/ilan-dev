    ...
    return (
        <>
            ...
            <div className="h-screen  overflow-y-scroll snap-y snap-mandatory scrollbar-hide relative">
                ...
                <motion.section
                    className="h-screen snap-start flex flex-col items-center justify-center min-h-screen  text-white font-mono text-center px-4 relative "
                    initial="hidden"
                    animate="visible"
                    variants={{
                        hidden: {},
                ...
                >
                    ...
                    <FaAngleDown
                        className="absolute bottom-10 text-blue-400 animate-bounce"
                        size={60}
                    />
                ...
                <motion.section
                    id="experience-1"
                    className=" pt-24 h-screen snap-start flex flex-col items-center justify-center min-h-screen  text-white font-mono text-center px-4"
                    initial="hidden"
                    whileInView="visible"
